...
$sqli = "INSERT INTO `sales_item` (`date`, `item_name`, `item_id`, `item_category`, `item_description`, `item_quantity`, `price_rate`, `discount_rate`, `amount`, `vat`, `vat_amount`, `sales_id`, `company_email`, `date_time`, `type`) SELECT `date_time`, `item_name`, `item_id`, `item_category`, `item_description`, `item_quantity`, `price_rate`, `discount_rate`, `amount`, `vat`, `vat_amount`, '$last_id', `company_email`, `date_time`, 'create sales invoice' FROM `inventory_goods` WHERE `goods_id` = '$id'";
$conn->query($sqli);
}

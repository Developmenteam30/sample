...
<?php  if($row['cat_type'] == 'purchase Receipt' || ($row['cat_type'] == 'purchase return' && $row['return_type'] == 'Bank Payment')){  ?>
     <div class="col-md-5 col-sm-5 col-xs-5" style="border:1px solid #000; margin-left: 15%;;padding: 0px 0px 0px 0px;min-height: 190px">
         ...
         <div class="indate" >
             <p style="padding-left: 10px"><?php echo $rowb['accounts_name']; ?>,<br>
             <?php echo $row['cheque_no']; ?>,<br></p>
         </div>
     </div>
    </div>
<?php } ?>
...
<div class="col-sm-12 hatjabeayame" style="max-width: 710px; margin-bottom: 40px; margin-top: 20px;padding: 0px 5px 0px 5px;">

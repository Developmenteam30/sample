...
$rowb= $newb->fetch_assoc();
  ...
  ?>
        ...
        <div  style="width: 100%;float: left;">
                ...
                <div>
                     <p style="padding-left: 10px">
                            ...
                            TRN: <?php echo $rowj['tax_number']; ?><br>
        ...
        <div  style="width: 100%;float: left;padding: 15px 0px 0px 0px; " >
            ...
            <div style="width: 45%;float: left;border:1px solid #000;padding: 0px 0px 0px 0px; margin-left: 5px;min-height: 190px;">
                <div style="border-bottom:1px solid #000;line-height: 15px">
                <p align="left" style="font-weight: bold; padding-right: 20px;border-bottom: 1px solid#000; padding-left: 10px">Payment Detials</p>
                </div>
                <div>
             <div style="padding-left: 10px;padding-top: 6px;width: 100%;float: left"><div style="width: 50%;float: left"><b>Bank Name:</b></div> 
             <div style="width: 50%;float: left"><?php echo $rowb['accounts_name']; ?>,<br><br></div> 
             <div style="width: 50%;float: left"><b>Cheque No:</b></div> 
             <div style="width: 50%;float: left"><?php if($row['cheque_no']!='undefined' && $row['cheque_no']!=''){ echo $row['cheque_no'].','; } ?><br><br></div> 
             <div style="width: 50%;float: left;padding-bottom: 10px"><b>Cheque Date:</b></div> 
             <div style="width: 50%;float: left;padding-bottom: 10px"><?php echo date('d-m-Y',strtotime($row['date'])); ?></div> <br>
             </div>
                </div>
            </div>

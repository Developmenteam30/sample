        ...
        <div  style="width: 100%;float: left;padding: 15px 0px 0px 0px; " >
            ...
            <div>
                 <p style="padding-left: 10px">
                            ...
                            TRN: <?php echo $rowi['tax_number']; ?></p><br><br><br>                        </div>
        </div>


        <div style="width: 50%;float: right;border:1px solid #000;padding: 0px 0px 0px 0px; margin-left: 5px;max-height: 150px;">
                <div style="border-bottom:1px solid #000;line-height: 15px">
             ...
             <div style="width: 50%;float: left;padding-bottom: 10px"><?php echo date('d-m-Y',strtotime($row['date'])); ?>

...
<div  style="width: 100%;float: left; height: 500px;">
    ...
    <col style="width: 19%">
		...
		<thead style=" width: 20%;border-top:1px solid #000; border-bottom:1px solid #000">
			<tr>
...
<?php   } } ?>
			<div style="border-top:solid 1px #000; border-bottom:1px solid #000;">
				<tr>
			        ...
			        <td class="" style="border: none;border-top:solid 1px black;text-align: left;">SUBTOTAL:</td>
        ...
        <td class="bot_col" style="border-top:solid 1px #ccc;border-bottom: 1px solid #000;text-align: left;">VAT:</td>
        <td class="bot_col" style="border-top:solid 1px #ccc;border-bottom: 1px solid #000;text-align: right;"><?php echo number_format($row['vat'], 2, '.', ','); ?></td>
      </tr>

		    <tr style="border-top:solid 1px #ccc; border-bottom:1px solid black; border:none;">
        <td colspan="3" class="bot_col" style="border-bottom: 1px solid #000"></td>
        <td class="bot_col" style="border-top:solid 1px #ccc;border-bottom: 1px solid #000;text-align: left;">TOTAL:</td>

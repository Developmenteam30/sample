    ...
    <col style="width: 16.66%">
		...
		<thead style="border-top:1px solid #000; border-bottom:1px solid #000">
			<tr>
		       ...
		       <th style=" border-bottom: 1px solid #000;text-align: right;border-right: 1px solid #a59d9d;">INVOICE. &nbsp;</th>
		        <th style=" border-bottom: 1px solid #000;text-align: right;border-right: 1px solid #a59d9d;">TOTAL &nbsp;</th>
...
<?php
$i=0;
$sl = "SELECT * FROM `customer_payment_list` WHERE `customer_payment_list_id` = '$id' ORDER BY `id` ASC";
$nes = $conn->query($sl);
...
?>
        ...
        <td style=" border:none;text-align: center; border-right: 1px solid #a59d9d;"><?php if($ross['discount_rate'] == ''){echo number_format('0', 2, '.', ','); }else{ echo number_format($ross['discount_rate'], 2, '.', ','); } ?> &nbsp;</td>
